...
(function(BH_UTILS, undefined) {
    ...
    BH_UTILS.bhWindow = function(content, title, btns, params, callback) {
        ...
        winParams.position = [window.innerWidth / 2 - parseInt(winParams.width, 10) / 2, (top.window.innerHeight) / 2 - iframe_top + $(top.window).scrollTop() - parseInt(winParams.height, 10) / 2];
