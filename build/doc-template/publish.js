...
function buildNav(members) {
    ...
    nav += buildMemberNav(members.modules, '组件', {}, linkto);
    nav += buildMemberNav(members.externals, '外部引用', seen, linktoExternal);
    ...
    if (members.globals.length) {
        ...
        if (!globalNav) {
            ...
            nav += '<h3>全局方法</h3><ul>' + globalNav + '</ul>';
        }
    }
...
exports.publish = function(taffyData, opts, tutorials) {
    ...
    if (members.globals.length) { generate('全局方法', [{kind: 'globalobj'}], globalUrl); }
